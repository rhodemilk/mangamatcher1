...
def load_manga_dataset(csv_file_path):
    ...
    try:
        ...
        # Commit all changes
        db.session.commit()
        print(f"Successfully loaded {loaded_count} manga entries into the database!")
...
def main():
    ...
    csv_file = "manga_shellhacks_cleaned_main.csv"
    ...
    with app.app_context():
        ...
        if success:
            ...
            print(f"Unique demographics: {[d[0] for d in demographics if d[0]]}")
